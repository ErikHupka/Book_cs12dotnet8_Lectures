partial class Program
{
  ...
  IEnumerable<(TElement Element, TPriority Priority)> collection)
    ...
    {
        WriteLine(value: $"Count before is {dictionary.Count}.");
        try
        {
            WriteLine(value: $"Adding new item with GUID values.");
        ...
        {
            WriteLine(value: $"This dictionary does not support the Add method.");
        }
        WriteLine(value: $"Count after is {dictionary.Count}");
    }
}