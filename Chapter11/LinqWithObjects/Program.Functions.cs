...
partial class Program
{
    ...
    {
        SectionTitle(title: "Deferred execution");
    ...
    {
        SectionTitle(title: "Filtering entities using Where");

        // Explicitly creating the required delegate.
        //var query = names.Where(predicate: new Func<string, bool>(NameLongerThanFour));
