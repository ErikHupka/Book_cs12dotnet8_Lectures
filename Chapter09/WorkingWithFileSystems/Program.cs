...
WriteLine(value: $"Folder Name: {GetDirectoryName(textFile)}");
WriteLine(value: $"File Name: {GetFileName(textFile)}");
WriteLine(value: $"File Name without Extensions: {GetFileNameWithoutExtension(textFile)}");
WriteLine(value: $"File Extension: {GetExtension(textFile)}");
...
SectionTitle(title: "Getting file information");
