...
WriteLine("Casting numbers implicitly and explicitly");

int a = 10;
double b = a; //An int can be safelz cast into a double
...
WriteLine("How negative numbers are represented in binary");
...
WriteLine("Converting with the System.Convert type");
...
WriteLine("Rounding numbers and the default rounding rules");
...
WriteLine("Taking control of rounding rules");
...
WriteLine("Converting from a binary object to a string");
...
WriteLine("Avoiding Parse exceptions by using the TryParse method");
