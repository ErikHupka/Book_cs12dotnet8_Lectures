...
//WriteLine(value: $"Provider: {db.Database.ProviderName}");
...
//{
//    WriteLine(value: $"Add product successful with ID: {resultAdd.productId}");
//}
...
//{
//    WriteLine(value: $"Increase price success for ID: {resultUpdate.productId}");
//}
